...
echo "Пароль администратора сервера (пользователь: $SUDO_USER):  $SUDO_USER_PASS"
echo "Пароль пользователя root: $ROOT_PASS"
echo "Порт SSH/SFTP: $SSH_PORT"
echo "Группа пользователей, имеющих доступ по SFTP: $SFTP_GROUP"
